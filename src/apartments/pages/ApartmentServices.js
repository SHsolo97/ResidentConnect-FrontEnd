  ...
  return (
    ...
    <>
      ...
      <div style={{ marginLeft: '400px', width: '500px' }}> <Paper style={{ padding: '40px' }}> <SectionHeader>Paid Services</SectionHeader>
        ...
        >
          <div>
            <FormControlLabel value={enrolledServices.maintenance} onChange={(e) => {
          ...
          <div>
            <FormControlLabel value={enrolledServices.visitor} onChange={(e) => {
              SetEnrolledService((prevState) => {
          ...
          <div>
            ...
            <FormControlLabel value={enrolledServices.polling} onChange={(e) => {
              SetEnrolledService((prevState) => {
          ...
          <div>
            ...
            <FormControlLabel value={enrolledServices.carpooling} onChange={(e) => {
              SetEnrolledService((prevState) => {
          ...
          <div>
            ...
            <FormControlLabel value={enrolledServices.facility} onChange={(e) => {
              SetEnrolledService((prevState) => {
