          ...
          >
            <div>
              <FormControlLabel checked={enrolledServices.maintenance}
                value={enrolledServices.maintenance} onChange={(e) => {
                  SetEnrolledService((prevState) => {
                    return { ...prevState, maintenance: !enrolledServices.maintenance }
                  })
            ...
            <div>
              <FormControlLabel checked={enrolledServices.visitor} value={enrolledServices.visitor} onChange={(e) => {
                SetEnrolledService((prevState) => {
                  return { ...prevState, visitor: !enrolledServices.visitor }
                })
              }} control={<Checkbox color="primary" />}
            ...
            <div>
              ...
              <FormControlLabel checked={enrolledServices.polling} value={enrolledServices.polling} onChange={(e) => {
                SetEnrolledService((prevState) => {
                  return { ...prevState, polling: !enrolledServices.polling }
                })
              }} control={<Checkbox color="primary" />}
                label="Polling"
                labelPlacement="end"
            ...
            <div>
              ...
              <FormControlLabel checked={enrolledServices.carpooling} value={enrolledServices.carpooling} onChange={(e) => {
                SetEnrolledService((prevState) => {
                  return { ...prevState, carpooling: !enrolledServices.carpooling }
                })
              }} control={<Checkbox color="primary" />}
                label="Car Pooling"
                labelPlacement="end"
            ...
            <div>
              ...
              <FormControlLabel checked={enrolledServices.facility} value={enrolledServices.facility} onChange={(e) => {
                SetEnrolledService((prevState) => {
                  return { ...prevState, facility: !enrolledServices.facility }
                })
              }} control={<Checkbox color="primary" />}
