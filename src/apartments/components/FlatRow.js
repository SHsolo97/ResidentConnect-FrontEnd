...
return (
<Grid item direction="row" justifyContent="flex-start" alignItems="center">
  ...
  <FormControl variant="outlined" className={classes.formControl}>
    <Select style={{ width: "175px" }} disabled={disabled} value={flat.status} onChange={setFlatStatusValue}>
  ...
  <TextField style={{ width: "175px" }} disabled={disabled} className={classes.formControl} variant="outlined" name="flatemail" onChange={setFlatEmailValue} value={flat.email} />

  {!disabled && <IconButton onClick={onSave} aria-label="save">
    <SaveIcon />
  </IconButton>
  }
  {!disabled && <IconButton onClick={onCancel} aria-label="cancel">
    <CancelIcon />
  </IconButton>
