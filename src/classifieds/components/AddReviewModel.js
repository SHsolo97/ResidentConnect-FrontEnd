...
_avgstar=calculateAverageStars(_1star,_2star,_3star,_4star,_5star,_totrating)
...
await classifiedAPI.put(apiBaseUrl,data )
...
await classifiedAPI.post(apiBaseUrl,commentData )
.then(function (response) {
